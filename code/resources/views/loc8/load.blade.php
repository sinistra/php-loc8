        	...
        	<tr>
        		<td width="25%" valign="top">
        			<div style="height: 350px;">
        				<br><div><button type="button" id="start_btn">start</button></div>
        				<br><div><button type="button" id="stop_btn">stop</button></div>
        				<br><div>from:<br><input type="text" id="val_from"></div>
        				<br><div>to:<br><input type="text" id="val_to"></div>
