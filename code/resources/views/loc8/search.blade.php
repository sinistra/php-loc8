...
<html lang="{{ app()->getLocale() }}">
    <head>
		...
		<style>
			...
			h3 { position: absolute; top: -7px; right: 30px; }
			h6 { color: red; }
			...
			#result_pane { display: none; border: 0px white solid; padding: 12px 20px 12px 20px; }
		...
		$(document).ready(function() {
			...
			var options = {
				url: function(phrase) {
					...
					uri_str = "http://localhost/loc8/qry/" + safeUrl(phrase) + "/10/" + search_type;
					console.log(uri_str);
					return uri_str;
				},
				getValue: "loc",
